...
import { likeReply, unlikeReply } from "../../../actions/réels.action";
import { UidContext, useDarkMode } from "../../Context/AppContext";
import AntDesign from 'react-native-vector-icons/AntDesign';
import Feather from 'react-native-vector-icons/Feather';

const LikeReplyButton = ({ réels, comment, reply, type }) => {
    ...
    const like = () => {
        ...
        dispatch(likeReply(réels._id, comment._id, reply._id, uid));
        setLiked(true);
    };
    ...
    const unlike = () => {
        ...
        dispatch(unlikeReply(réels._id, comment._id, reply._id, uid));
        setLiked(false);
    };
