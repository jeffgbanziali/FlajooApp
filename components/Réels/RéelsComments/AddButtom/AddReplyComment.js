...
import { getVideoReels,replyComment } from "../../../../actions/réels.action";
...
const AddReplyComment = ({ réels, selectedComment, partVisible }) => {
    ...
    const handleComment = async () => {
        try {
            ...
            if (userData._id && (text || mediaType) && selectedComment) {
                saveCommentLocally(
                    réels._id,
                    selectedComment._id,
                    userData._id,
