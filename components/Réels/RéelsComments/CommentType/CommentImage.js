...
const CommentImage = ({ réels, comment, toggle, toAnswering, toReplying }) => {
                                    ...
                                    <View key={reply._id}>
                                        ...
                                        {reply.repliedTo && reply.replyMedia && (
                                            ...
                                            <>
                                                ...
                                                {reply.replyType === "audio" && (
                                                    <ReplyToAudio index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                            </>
                                        )
                                        }
