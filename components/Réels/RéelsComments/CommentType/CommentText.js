...
const CommentText = ({ réels, comment, toggle, toAnswering, toReplying }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <LikeCommentButton réels={réels} comment={comment} type={"postPicture"} />
                                ...
                                return (
                                    ...
                                    <View key={reply._id}>
                                        {!reply.repliedTo && reply.replyMedia && (
                                            ...
                                            <>
                                                {reply.replyType === "gif" && (
                                                    <ReplyGif index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                                {reply.replyType === "image" && (
                                                    <ReplyImage index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                                {reply.replyType === "video" && (
                                                    <ReplyVideo index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                                {reply.replyType === "audio" && (
                                                    <ReplyAudio index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                            </>
                                        )
                                        }
                                        {!reply.repliedTo && reply.text && (
                                            ...
                                            <ReplyText index={index} réels={réels} comment={comment} reply={reply} replierImage={replierImage} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />

                                        )
                                        }
                                        {reply.repliedTo && reply.text && (
                                            <ReplyToText index={index} réels={réels} comment={comment} reply={reply} replierImage={replierImage} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                        )
                                        }
                                        ...
                                        {reply.repliedTo && reply.replyMedia && (
                                            ...
                                            <>
                                                {reply.replyType === "gif" && (
                                                    <ReplyToGif index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                                {reply.replyType === "image" && (
                                                    <ReplyToImage index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                                {reply.replyType === "video" && (
                                                    <ReplyToVideo index={index} réels={réels} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                                {reply.replyType === "audio" && (
                                                    <ReplyToAudio index={index} réels={poréelsst} comment={comment} replierImage={replierImage} reply={reply} toAnswering={toAnswering} toggle={toggle} toReplying={toReplying} />
                                                )}
                                            </>
                                        )
                                        }
